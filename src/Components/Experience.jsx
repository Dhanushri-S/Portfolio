            ...
            {EXPERIENCES.map((experience , index) =>(
                <div key={index} className='mb-8 flex flex-wrap lg:justify-center'>
                    ...
                    className="w-full max-w-xl lg:w-3/4 ">
                        ...
                        {/* <p>{experience.technologies.map((techology, index) =>(
                            <span key={index} className='mr-2 mt-4 rounded bg-neutral-900 px-2 py-1 inline-block text-sm font-medium text-purple-800'>{techology}</span>
                        ))}</p> */}
